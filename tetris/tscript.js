...
// What happens to a shape when a key is pressed
const moves = {
...
// Determine what happens when a certain key is pressed
...
// Pieces stack too high -> Game Over
function gameOver() {
    cancelAnimationFrame(requestId);
...
// Check locally stored high scores
...
// Save a high score to the local tiny database
